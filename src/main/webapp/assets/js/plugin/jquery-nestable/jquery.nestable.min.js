...
!function (a, b, c, d) {
    function e(b, d) {
        this.w = a(c), this.el = a(b), this.options = a.extend({}, h, d), this.init()
    }

    var f = "ontouchstart" in c, g = function () {
    ...
    e.prototype = {
        "init": function () {
            ...
            c.reset(), c.el.data("nestable-group", this.options.group), c.placeEl = a('<div class="' + c.options.placeClass + '"/>'), a.each(this.el.find(c.options.itemNodeName), function (b, d) {
                ...
                if (!c.dragEl) {
                    var d = a(b.currentTarget), e = d.data("action"), f = d.parent(c.options.itemNodeName);
                    "collapse" === e && c.collapseItem(f), "expand" === e && c.expandItem(f)
                }
            });
            var d = function (b) {
                var d = a(b.target);
                ...
                d.length && !c.dragEl && (c.isTouch = /^touch/.test(b.type), c.isTouch && 1 !== b.touches.length || (b.preventDefault(), c.dragStart(b.touches ? b.touches[0] : b)))
            }, e = function (a) {
                c.dragEl && (a.preventDefault(), c.dragMove(a.touches ? a.touches[0] : a))
            }, g = function (a) {
                c.dragEl && (a.preventDefault(), c.dragStop(a.touches ? a.touches[0] : a))
            };
            f && (c.el[0].addEventListener("touchstart", d, !1), b.addEventListener("touchmove", e, !1), b.addEventListener("touchend", g, !1), b.addEventListener("touchcancel", g, !1)), c.el.on("mousedown", d), c.w.on("mousemove", e), c.w.on("mouseup", g)
        }, "serialize": function () {
            var b, c = 0, d = this;
