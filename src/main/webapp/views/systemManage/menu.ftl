                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="menuTitle" id="menuTitle" readonly>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">菜单链接</label>
                                        <label class="input">
                                            <input type="text" name="menuUrl" id="menuUrl" readonly>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">图标样式</label>
                                        <label class="input">
                                            <input type="text" name="menuPic" id="menuPic" readonly>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label class="label">菜单级别</label>
                                        <label class="input">
                ...
                <form id="modelForm" class="form-horizontal">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="menuTitle" class="form-control" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2">图标样式</label>
                            <div class="col-md-4">
                                <input name="menuPic" class="form-control" type="text">
                            </div>

                            <label class="control-label col-md-2">菜单级别</label>
                            <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (!window.sessionStorage.getItem("menuStatus")) {
            $.ajax({
                url: "/item/menuStatus",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.code == "100000") {
                        window.sessionStorage.setItem("menuStatus", JSON.stringify(data.data));
        ...
        if (!menuStatus) {
            menuStatus = JSON.parse(window.sessionStorage.getItem("menuStatus"));
        }
        $.each(menuStatus, function (key, value) {
    ...
    function initTree() {
        $.get({
            ...
            success: function (data) {
                if (data.code == "100000") {
                    $("#tree").tree().init(data.data, "subMenus", "menuTitle");
